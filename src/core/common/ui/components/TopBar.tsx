              ...
              <div className="mobile-nav-inner">
                ...
                {showSocialIcons && (
                  <div className="mobile-nav-social">
                    <a href={SOCIAL_LINKS.whatsapp} target="_blank" rel="noopener noreferrer" className="mobile-nav-social-link" aria-label="WhatsApp">
                    ...
                    <a href={SOCIAL_LINKS.instagram} target="_blank" rel="noopener noreferrer" className="mobile-nav-social-link" aria-label="Instagram">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
                    ...
                    <a href={SOCIAL_LINKS.linkedin} target="_blank" rel="noopener noreferrer" className="mobile-nav-social-link" aria-label="LinkedIn">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
